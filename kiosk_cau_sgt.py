...
class Which_Professor_Sgt_1(tk.Frame):

    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        background_main_img=tk.PhotoImage(file=f"which_prof_sgt_1.png")   #사회기반시스템공학부
        ...
        tab_btn_img=tk.PhotoImage(file=f"which_prof_sgt_1_tab.png")
        ...
        #tab_button1 = tk.Button(self, image = tab_btn_img, bg = "blue2", overrelief="flat", relief="flat",
                           command=lambda: controller.show_frame("Which_Professor_Sgt_2")) 


        prof_btn1_img=tk.PhotoImage(file=f"which_prof_sgt_1_kkj.png")
        ...
        button1 = tk.Button(self, image = prof_btn1_img, bg = "white", overrelief="flat", relief="flat", borderwidth = 0, highlightthickness = 0,
                           command=lambda: controller.show_frame("kkj")) 

        prof_btn1_img=tk.PhotoImage(file=f"which_prof_sgt_1_kjh.png")
        prof_btn1_img = prof_btn1_img.zoom(10)
        prof_btn1_img = prof_btn1_img.subsample(17)
        prof_btn1 = tk.Label(self, image=prof_btn1_img)
        prof_btn1.image = prof_btn1_img
        button2 = tk.Button(self, image = prof_btn1_img, bg = "white", overrelief="flat", relief="flat", borderwidth = 0, highlightthickness = 0,
                           command=lambda: controller.show_frame("kjh")) 

        prof_btn1_img=tk.PhotoImage(file=f"which_prof_sgt_1_pkh.png")
        prof_btn1_img = prof_btn1_img.zoom(10)
        prof_btn1_img = prof_btn1_img.subsample(17)
        prof_btn1 = tk.Label(self, image=prof_btn1_img)
        prof_btn1.image = prof_btn1_img
        button3 = tk.Button(self, image = prof_btn1_img, bg = "white", overrelief="flat", relief="flat", borderwidth = 0, highlightthickness = 0,
                           command=lambda: controller.show_frame("pkh")) 

        tab_button1.place(x = 223, y = 90)
        button1.place(x = 85, y = 153)
        button2.place(x = 228, y = 153)
        button3.place(x = 385, y = 153)
        
class Which_Professor_Sgt_2(tk.Frame):

    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        background_main_img=tk.PhotoImage(file=f"which_prof_sgt_2.png")   #사회기반시스템공학부 2
        background_main_img = background_main_img.zoom(10)
        background_main_img = background_main_img.subsample(17)
        background_main = tk.Label(self, image=background_main_img)
        background_main.image = background_main_img
        ...
        tab_btn_img=tk.PhotoImage(file=f"which_prof_sgt_2_tab.png")
        tab_btn_img = tab_btn_img.zoom(10)
        tab_btn_img = tab_btn_img.subsample(17)
        tab_btn = tk.Label(self, image=tab_btn_img)
        tab_btn.image = tab_btn_img
